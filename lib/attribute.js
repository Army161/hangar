...
const SIGNATURES = [
  ...
  // Found by the Port Wall on this machine and previously unattributed.
  { re: /OpenClaw\.Tray/i, kind: KIND.AGENT, name: 'OpenClaw Tray', reattach: true },
  { re: /kortix|suna[\\/]/i, kind: KIND.AGENT, name: 'Kortix', reattach: true },
  { re: /[\\/]odysseus[\\/]|odysseus-odysseus/i, kind: KIND.PROJECT, name: 'Odysseus', reattach: true },
  { re: /\bdyad\b/i, kind: KIND.APP, name: 'dyad' },
